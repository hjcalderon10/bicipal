...
class Post extends Component {
    ...
    renderLikes() {
        ...
        switch (post.likes.length - likeSub) {
            case 0:
              return likeSub > 0 ? 'Irás al evento' : '';
            case 1:
                return likeSub > 0 ? `${likes} 1 persona distinta está interesada en el evento` : '1 persona está interesada en el evento';
            default:
                return `${likes} ${post.likes.length - likeSub} personas están interesadas en el evento`;
        }
    }
