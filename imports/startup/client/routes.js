    ...
    render(
        <Router history={ browserHistory }>
            ...
            <Route path="/dashboard" component={ Layout }>
                ...
                <Route name="map" path="/map" component={{ sidebar: Sidebar, content: Map }} onEnter={ authenticate } />
                <Route name="weather" path="/weather" component={{ sidebar: Sidebar, content: Weather }} onEnter={ authenticate } />
